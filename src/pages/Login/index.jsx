            ...
            <div className="rounded-lg max-w-md w-full flex flex-col items-center justify-center relative">
                ...
                <form className="w-full space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div>
                        ...
                        id="email"
                        type="email"
                        className="block appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray-2000 focus:border-gray-200"
                        />
                    </div>
                    <div>
                        <label 
